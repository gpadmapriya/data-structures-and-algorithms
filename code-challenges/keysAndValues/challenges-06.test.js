...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach(characterObj => {
    if ((characterObj.name === character) && (Object.values(characterObj)[2].length) !== 0) {
      result = true;
    }
  });
  return result;
...
const hasChildrenEntries = (arr, character) => {
  let result = false;
  arr.forEach(characterObj => {
    if ((characterObj.name === character) && (Object.entries(characterObj)[2][1].length) !== 0) {
      result = true;
    }
  });
  return result;
...
const totalCharacters = (arr) => {
  ...
  arr.forEach(characterObj => {
    characterArray = Object.values(characterObj).flat();
