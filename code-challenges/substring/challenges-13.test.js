...
const sortByDay = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    if (arr[i].includes('Monday')) {
      retArr[daysOfWeek.indexOf('Monday')].push(arr[i]);
    }
    if (arr[i].includes('Tuesday')) {
      retArr[daysOfWeek.indexOf('Tuesday')].push(arr[i]);
    }
    if (arr[i].includes('Wednesday')) {
      retArr[daysOfWeek.indexOf('Wednesday')].push(arr[i]);
    }
    if (arr[i].includes('Thursday')) {
      retArr[daysOfWeek.indexOf('Thursday')].push(arr[i]);
    }
    if (arr[i].includes('Friday')) {
      retArr[daysOfWeek.indexOf('Friday')].push(arr[i]);
    }
    if (arr[i].includes('Saturday')) {
      retArr[daysOfWeek.indexOf('Saturday')].push(arr[i]);
    }
    if (arr[i].includes('Sunday')) {
      retArr[daysOfWeek.indexOf('Sunday')].push(arr[i]);
    }
