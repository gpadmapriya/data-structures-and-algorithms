...
const sortByLength = (arr) => {
  return arr.sort(compareByLength);
};
...
const alphabetizeBetter = (arr) => {
  return arr.sort(compareBetter);
};

const compareBetter = (a, b) => {
...
const sortNumbersByLength = (arr) => {
  return arr.sort(compareNumbersByLength);
};

const compareNumbersByLength = (a, b) => {
...
const sortPeopleBetter = (arr) => {
  return arr.sort(comparePeopleBetter);
};

const comparePeopleBetter = (a, b) => {
...
const sortMeetingsByDay = (arr) => {
  return arr.sort(compareByDay);
};

const compareByDay = (a, b) => {
  if (daysOfWeek.indexOf(a.dayOfWeek) < daysOfWeek.indexOf(b.dayOfWeek)) {
    return -1;
  }
  if (daysOfWeek.indexOf(a.dayOfWeek) > daysOfWeek.indexOf(b.dayOfWeek)) {
    return 1;
...
const sortSchedule = (arr) => {
  return arr.sort(compareByTime);
};

const compareByTime = (a, b) => {
  if (daysOfWeek.indexOf(a.dayOfWeek) < daysOfWeek.indexOf(b.dayOfWeek)) {
    return -1;
  } else if (daysOfWeek.indexOf(a.dayOfWeek) > daysOfWeek.indexOf(b.dayOfWeek)) {
    return 1;
